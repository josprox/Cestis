              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                    <div class="text">
                      <h2>Hay alguien que quiere ser tú amigo!!!</h2>
                    </div>
                  </td>
                </tr>
                <tr>
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <tr>
            <td class="bg_light" style="text-align: center;">
              <p>Tú has recibido este correo porque estás activo en "Cristal", si quieres evitar estos correos, tendrás que <a href="#" style="color: rgba(0,0,0,.8);">hablar con administración</a> para solicitar la eliminación de tu cuenta en "Cristal"</p>
            </td>
          </tr>
        </table>
...
try {
    ...
    //Recipients
    $mail->setFrom( 'correo de envío', $minombre);
